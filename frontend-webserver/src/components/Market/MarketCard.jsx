...
const MarketCard = ({ listingId, walletAddress, tokenId, quantity,
  ...
  const handleViewDetailsButtonClick = () => {
    setSelectedCard({ listingId, walletAddress, tokenId, quantity, price, image, name, description })
    const dynamicRoute = `/marketplace/listings/${walletAddress}/${tokenId}`
  ...
  return (
    ...
    >
      ...
      <div className="px-6 py-4">
        ...
        <div className="font regular text-lg mb-2 text-gold2">{price} PSD</div>
      </div>
          {isHovered && (
